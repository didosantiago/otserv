...
forgeMinSlivers = 3
forgeMaxSlivers = 7
forgeInfluencedLimit = 5
forgeFiendishLimit = 1
...
coinPacketSize = 25
coinImagesURL = "http://" .. ip .. ":8080/images/store/"
